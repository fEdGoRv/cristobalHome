    ...
    >
      ...
      {animation === catId &&
        <div
          ...
          className={`absolute inset-0 flex flex-col text-center justify-center items-center bg-grisCard bg-opacity-50 text-black transition-opacity duration-300 ${active ? "opacity-100" : "opacity-0"
            }`}
        >
          <div>
            ...
            <div className={`action ${active ? "active" : ""}`}>
